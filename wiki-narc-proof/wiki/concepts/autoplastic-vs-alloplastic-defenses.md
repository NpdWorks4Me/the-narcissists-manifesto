---
title: Autoplastic vs Alloplastic Defenses
summary: Autoplastic defenses accept responsibility for one's actions, while alloplastic defenses blame others and imply an external locus of control; therapy should reward autoplastic defenses and use language shifts ('I did it' vs 'it happened to me').
sources:
  - yt-l7xhxkpxx0e.md
kind: concept
createdAt: "2026-09-01T05:16:31.157Z"
updatedAt: "2026-09-01T05:16:31.157Z"
tags:
  - defense-mechanisms
  - accountability
...
The recommended approach is to help the person regain an internal locus of control by gradually transferring responsibility back to her. The partner is advised not to threaten, demand, control, or criticize, but instead to be kind and supportive, allowing her increasing control over her circumstances, choices, decisions, and emotions. Autoplastic behaviors should be rewarded when warranted, and attempts to place blame on the partner should be lovingly rejected. ^[yt-l7xhxkpxx0e.md:9]

A simple language exercise is offered as an example: if the person says, “I was drunk and I slept with another man. It happened,” the partner may respond, “It did not happen. You did it.” This is presented as a way to restore responsibility, self-control, and an internal locus of control. ^[yt-l7xhxkpxx0e.md:9]
...
- `yt-l7xhxkpxx0e.md` — YouTube video transcript “yt l7xhxKpXx0E” (research log, ingested 2026-09-01).
